      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 md:px-10 py-20 md:py-24 space-y-14">
        ...
        <section className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            className="nova-glow rounded-2xl p-7 h-full relative overflow-hidden"
          >
          ...
          >
            ...
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <h2 className="text-3xl font-bold text-[#C9EB55]">Priority Support</h2>
                <p className="text-white/60">
              ...
              <ul className="space-y-3 text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-[#C9EB55] mt-1 shrink-0" />
                  <span>Typical response within 10 minutes to 4 hours</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-[#C9EB55] mt-1 shrink-0" />
