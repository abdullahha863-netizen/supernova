        ...
        <>
            ...
            >
              <div className="relative">
                ...
                <motion.div 
                  className="absolute top-[35%] left-[25%] w-1.5 h-1.5 bg-red-500 rounded-full shadow-[0_0_8px_#ef4444]"
                ...
                <motion.div 
                  className="absolute top-[35%] right-[25%] w-1.5 h-1.5 bg-blue-500 rounded-full shadow-[0_0_8px_#3b82f6]"
                  animate={{ opacity: [0, 1, 0] }}
                  transition={{ duration: 1.5, repeat: Infinity, delay: 0.75, repeatDelay: 0.2 }}
                />

                {/* Orange Light - Back Left */}
                <motion.div 
                  className="absolute bottom-[40%] left-[25%] w-1.5 h-1.5 bg-orange-500 rounded-full shadow-[0_0_8px_#f97316]"
                  animate={{ opacity: [0, 1, 0] }}
                  transition={{ duration: 1.5, repeat: Infinity, delay: 0.4, repeatDelay: 0.2 }}
                />

                {/* Green Light - Back Right */}
                <motion.div 
                  className="absolute bottom-[40%] right-[25%] w-1.5 h-1.5 bg-green-500 rounded-full shadow-[0_0_8px_#22c55e]"
                  animate={{ opacity: [0, 1, 0] }}
                  transition={{ duration: 1.5, repeat: Infinity, delay: 1.15, repeatDelay: 0.2 }}
                />

                {/* Subtle Scanning Beam */}
                <motion.div 
                  className="absolute top-[55%] left-1/2 -translate-x-1/2 w-24 h-48 bg-gradient-to-b from-[#C9EB55]/5 to-transparent"
                  style={{ 
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8 py-12 min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start pt-20">
          ...
          >
            <h1 className="relative w-fit text-6xl lg:text-7xl font-black leading-[0.9]">
              ...
              <span className="text-[#C9EB55]">GO</span>
              <br />
              <span className="text-[#C9EB55]">SILVER</span>
            </h1>

            <p className="text-xl text-white leading-relaxed max-w-xl">
              Take your mining operation to the next level with <span className="text-[#C9EB55] font-semibold">advanced monitoring</span>, 
              Guardian Basic / Scout protection, and priority infrastructure.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              >
                ...
                <div className="text-lg font-bold text-[#C9EB55] mb-1">Guardian Basic / Scout</div>
                <p className="text-xs text-white leading-relaxed">Basic monitoring and protection alerts. Activate Guardian with a Security PIN to enable protection. Emergency Lock: Not included.</p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-medium text-white/80">Priority Support</span>
                </div>
                <div className="text-lg font-bold text-[#C9EB55] mb-1">10-24 hours</div>
                <p className="text-xs text-white leading-relaxed">Get support through a dedicated member route with a typical response window of 10 to 24 hours.</p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-medium text-white/80">Exclusive Offers</span>
                </div>
                <div className="text-lg font-bold text-[#C9EB55] mb-1">Early Bird Discount</div>
                <p className="text-xs text-white leading-relaxed">Get exclusive discounts, promo codes, and special offers available only for Silver tier members.</p>
              </motion.div>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h4 className="text-sm font-bold text-[#C9EB55]">Physical Metal Card</h4>
                      <span className="text-xs px-2 py-0.5 rounded-full bg-[#C9EB55]/20 text-[#C9EB55]">Limited Edition</span>
                    </div>
                    <p className="text-xs text-white leading-relaxed">Premium brushed metal card with your unique Silver tier ID. Includes exclusive access to partner events and mining conventions worldwide.</p>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  ...
                  "Guardian Basic / Scout protection monitoring",
                  "Guardian activation with Security PIN",
                  "Support response: 10-24 hours",
                  "Extended performance analytics & insights",
                  "Reduced pool fee: 3.2%",
                  "Beta access to new features",
                  "Multi-rig support (up to 50 rigs)"
                ].map((item, i) => (
                  <motion.div 
                    key={i} 
            ...
            >
              <p className="mb-4 text-sm text-white/70">
                First payment: <span className="text-[#C9EB55] font-semibold">$112.99</span> (includes metal card + 3-month subscription). After the first 3 months, you only pay the subscription: $14.99 every cycle.
              </p>
              ...
              >
                <span className="relative z-10">Upgrade to Silver Now</span>
          ...
          >
            <div
              className="relative w-full aspect-[1/0.6] rounded-3xl"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              {
                q: "What is included in the Silver Tier?",
                a: "Silver Tier includes advanced real-time monitoring, Guardian Basic / Scout protection monitoring, Security PIN activation for Guardian, a 10-24 hour support response window, extended analytics, beta access to new features, and multi-rig support for up to 50 rigs. Emergency Lock is not included."
              },
              {
                q: "How does Guardian Basic / Scout work?",
                a: "Guardian Basic / Scout provides protection monitoring and alerts after you activate Guardian with a Security PIN. Emergency Lock is available on Hash Pro and Titan Elite."
              },
              {
              ...
              },
              {
                ...
                a: "Yes! Silver tier members get exclusive access to early bird discounts, special promo codes, and limited-time offers. Check your dashboard after upgrading for available coupons."
              },
              {
                q: "Is there a long-term contract?",
                a: "No contracts or commitments. You can cancel or change your plan at any time from your account settings with no penalties."
              },
              {
                q: "How do I get priority support?",
                a: "Silver members get access to a dedicated support route with a typical response window of 10-24 hours. You'll find the support contact details in your dashboard after upgrading."
              },
              {
                q: "Is express shipping available for the Silver metal card?",
                a: "Yes, express shipping is available for the Silver metal card. The cost of express shipping varies from country to country depending on the courier and region. You can select express shipping during checkout, and the final price will be shown before completing your order."
              },
              {
                q: "Will I receive tracking information for my Silver metal card?",
                a: "Yes, after completing your purchase, you will receive an email containing all shipping and tracking details for your Silver metal card."
              }
            ].map((faq, idx) => (
              <motion.div
                key={idx}
