...
import { Check, Shield, Clock, Gauge, ArrowUpRight, X, HelpCircle, Percent, CreditCard, Gem, MapPin, Truck, Crown, Scan } from "lucide-react";
...
export default function HashProUpgradePage() {
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-8 py-12 min-h-screen">
          ...
          >
            <div className="space-y-4">
              ...
              <h1 className="relative w-fit text-6xl lg:text-7xl font-black leading-[0.9]">
                ...
                <span className="text-[#C9EB55]">HASH</span>
                <br />
                <span className="text-[#C9EB55]">PRO</span>
              </h1>
            </div>

            <p className="text-xl text-white leading-relaxed max-w-xl">
              Upgrade into a more exclusive operating tier with <span className="text-[#C9EB55] font-semibold">premium monitoring</span>,
              Guardian Advanced protection, Emergency Lock availability, and a physical Hash Pro metal access card.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-medium text-white/80">Monitoring Layer</span>
                </div>
                <div className="text-lg font-bold text-[#C9EB55] mb-1">Expanded Visibility</div>
                <p className="text-xs text-white leading-relaxed">Track more operational signals with a sharper performance view built for advanced miners.</p>
              </motion.div>
              ...
              >
                ...
                <div className="text-lg font-bold text-[#C9EB55] mb-1">Guardian Advanced</div>
                <p className="text-xs text-white leading-relaxed">Advanced monitoring and stronger protection response. Activate Guardian with a Security PIN to enable protection. Emergency Lock: Available.</p>
              </motion.div>
              ...
              >
                ...
                <div className="text-lg font-bold text-[#C9EB55] mb-1">6-12 hours</div>
                <p className="text-xs text-white leading-relaxed">Move through a higher support lane with a typical response window of 6 to 12 hours.</p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-medium text-white/80">Tier Benefits</span>
                </div>
                <div className="text-lg font-bold text-[#C9EB55] mb-1">VIP Perks</div>
                <p className="text-xs text-white leading-relaxed">Unlock a more premium access tier with stronger feature coverage, exclusive member positioning, and access to renewal promo rewards.</p>
              </motion.div>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h4 className="text-sm font-bold text-[#C9EB55]">Hash Pro Metal Card</h4>
                      <span className="text-xs px-2 py-0.5 rounded-full bg-[#C9EB55]/20 text-[#C9EB55]">Member Access</span>
                    </div>
                    <p className="text-xs text-white leading-relaxed">A premium brushed metal card tailored for Hash Pro members, designed to reflect elevated access inside the SUPERNOVA ecosystem.</p>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  "Expanded monitoring and control visibility",
                  "Guardian Advanced protection monitoring",
                  "Guardian activation with Security PIN",
                  "Support response: 6-12 hours",
                  "Emergency Lock: Available",
                  "Reduced pool fee: 2.4%",
                  "Reward forecasting and higher-tier insights",
                  "VIP-oriented account positioning",
                  "Physical Hash Pro metal member card",
                ].map((item, i) => (
                  <motion.div
                    key={i}
            ...
            >
              <p className="mb-4 text-sm text-white/70">
                First payment: <span className="text-[#C9EB55] font-semibold">$134.99</span> (includes metal card + 3-month subscription). After the first 3 months, you only pay the subscription: $34.99 every cycle.
              </p>
              ...
              >
                <span className="relative z-10">Upgrade to Hash Pro</span>
          ...
          >
            ...
            >
              ...
              <div className="relative w-full h-full rounded-3xl border-2 border-[#C9EB55] bg-gradient-to-br from-[#1a1f2e] to-[#0b0e14] overflow-hidden shadow-2xl">
                ...
                <div className="relative w-full h-full flex items-center justify-center p-6">
                  <Image
                    src="/uploads/hashpro.png"
                    alt="Hash Pro metal card"
                    width={900}
                    height={620}
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-[#C9EB55] font-bold mb-2">VIP Access Card Identity</h3>
                  <p className="text-sm text-white leading-relaxed">
                    The Hash Pro card is presented as a member-facing premium asset, tying upgraded identity, access, and brand presence into one physical piece.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              {
                q: "What does Hash Pro include?",
                a: "Hash Pro includes stronger monitoring visibility, Guardian Advanced protection, Security PIN activation for Guardian, Emergency Lock availability, a 6-12 hour support response window, upgraded tier benefits, and a physical Hash Pro member card.",
              },
              {
                q: "Is the Hash Pro card physical?",
                a: "Yes. The Hash Pro card is a physical brushed metal member card tied to the upgraded tier experience.",
              },
              {
                q: "Who is Hash Pro best for?",
                a: "Hash Pro fits miners who want stronger visibility, Guardian Advanced protection, Emergency Lock availability, more premium support handling, and a more exclusive tier position than Silver.",
              },
              {
                q: "Does Hash Pro improve security coverage?",
                a: "Yes. Hash Pro includes Guardian Advanced protection after Security PIN activation, plus Emergency Lock availability for account freeze scenarios.",
              },
              {
                q: "Can I move into Hash Pro later?",
                a: "Yes. You can upgrade into Hash Pro when you're ready for a more premium operating tier.",
              },
              {
                q: "Will I receive shipping details for the card?",
                a: "Yes. Once the purchase is completed, shipping and tracking information for the Hash Pro card can be sent by email.",
              },
            ].map((faq, idx) => (
              <motion.div
                key={idx}
