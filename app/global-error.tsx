        ...
        <div className="relative min-h-screen overflow-hidden bg-black text-white">
          ...
          <div className="relative mx-auto flex min-h-screen max-w-3xl items-center justify-center px-6 py-16">
            <section className="w-full rounded-[32px] border border-[#C9EB55]/20 bg-white/[0.035] p-8 text-center shadow-[0_24px_80px_rgba(0,0,0,0.55)] backdrop-blur-xl md:p-12">
              <p className="text-[11px] font-semibold uppercase tracking-[0.32em] text-[#C9EB55]/80">Critical Error</p>
              ...
              <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-white/68 md:text-base">
                A root-level error prevented the app from rendering correctly. Try loading the app again or head back
                to the homepage.
              </p>
